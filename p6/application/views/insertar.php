...
<div id="container">
	...
	<div id="body">
		...
		<form action="http://localhost/code/index.php/Lectura/alta_persona" method="post">
		...
		<input type="text" name="nombre_comp" id="nombre_comp" required><br>

		<label for="fecha_nac">Fecha nacimiento:</label>
		<input type="date" name="fecha_nac" id="fecha_nac" required><br>

		<label for="apellido">Telefono:</label>
		<input type="text" name="telefono" id="telefono" value="(591)" required><br>
